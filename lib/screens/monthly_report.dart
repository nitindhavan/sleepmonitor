                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Bar(height: durationScore(surveyList[0].answers)*2,label: Text('${local.week} 1'),topLabel: Text('${durationScore(surveyList[0].answers)}'),),
                            if(surveyList.length>1)Bar(height: durationScore(surveyList[1].answers)*2,label: Text('${local.week} 2'),topLabel: Text('${durationScore(surveyList[1].answers)}'),),
                            if(surveyList.length>2)Bar(height: durationScore(surveyList[2].answers)*2,label: Text('${local.week} 3'),topLabel: Text('${durationScore(surveyList[2].answers)}'),),
                            if(surveyList.length>3)Bar(height: durationScore(surveyList[3].answers)*2,label: Text('${local.week} 4'),topLabel: Text('${durationScore(surveyList[3].answers)}'),),
                            if(surveyList.length>4)Bar(height: durationScore(surveyList[4].answers)*2,label: Text('${local.week} 5'),topLabel: Text('${durationScore(surveyList[4].answers)}'),),
                          ],
                        ),
                      ),
                    ),
                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(height: 200,),
                            Bar(height: (surveyList[0].answers[4])*50,label: Text('${local.week} 1'),topLabel: Text(getNapData(surveyList[0].answers,4),)),
                            if(surveyList.length>1)Bar(height: (surveyList[1].answers[4])*50,label: Text('${local.week} 2'),topLabel: Text(getNapData(surveyList[1].answers,4),)),
                            if(surveyList.length>2)Bar(height: (surveyList[2].answers[4])*50,label: Text('${local.week} 3'),topLabel: Text(getNapData(surveyList[2].answers,4),)),
                            if(surveyList.length>3)Bar(height: (surveyList[3].answers[4])*50,label: Text('${local.week} 4'),topLabel: Text(getNapData(surveyList[3].answers,4),)),
                            if(surveyList.length>4)Bar(height: (surveyList[4].answers[4])*50,label: Text('${local.week} 5'),topLabel: Text(getNapData(surveyList[4].answers,4),)),
                          ],
                        ),
                      ),
                    ),
                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(height: 200,),
                            Bar(height: (surveyList[0].answers[5])*50,label: Text('${local.week} 1'),topLabel: Text(getNapData(surveyList[0].answers,5),)),
                            if(surveyList.length>1)Bar(height: (surveyList[1].answers[5])*50,label: Text('${local.week} 2'),topLabel: Text(getNapData(surveyList[1].answers,5),)),
                            if(surveyList.length>2)Bar(height: (surveyList[2].answers[5])*50,label: Text('${local.week} 3'),topLabel: Text(getNapData(surveyList[2].answers,5),)),
                            if(surveyList.length>3)Bar(height: (surveyList[3].answers[5])*50,label: Text('${local.week} 4'),topLabel: Text(getNapData(surveyList[3].answers,5),)),
                            if(surveyList.length>4)Bar(height: (surveyList[4].answers[5])*50,label: Text('${local.week} 5'),topLabel: Text(getNapData(surveyList[4].answers,5),)),
                          ],
                        ),
                      ),
                    ),
                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(height: 200,),
                            Bar(height: (surveyList[0].answers[8])*50,label: Text('${local.week} 1'),topLabel: getMoodData(surveyList[0].answers,8,),color: Color(0xffe5e5ff),),
                            if(surveyList.length>1)Bar(height: (surveyList[1].answers[8])*50,label: Text('${local.week} 2'),topLabel: getMoodData(surveyList[1].answers,8,),color: Color(0xffe5e5ff),),
                            if(surveyList.length>2)Bar(height: (surveyList[2].answers[8])*50,label: Text('${local.week} 3'),topLabel: getMoodData(surveyList[2].answers,8,),color: Color(0xffe5e5ff),),
                            if(surveyList.length>3)Bar(height: (surveyList[3].answers[8])*50,label: Text('${local.week} 4'),topLabel: getMoodData(surveyList[3].answers,8,),color: Color(0xffe5e5ff),),
                            if(surveyList.length>4)Bar(height: (surveyList[4].answers[8])*50,label: Text('${local.week} 5'),topLabel: getMoodData(surveyList[4].answers,8,),color: Color(0xffe5e5ff),),
                          ],
                        ),
                      ),
                    ),
